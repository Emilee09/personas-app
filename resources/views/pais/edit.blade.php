  ...
  <div class="container">
    ...
    <form method="POST" action="{{ route('paises.update', ['pais' => $pais->pais_codi]) }}">
        ...
        <div class="mb-3">
            ...
            <div id="codigoHelp" class="form-text">Country code.</div>
        </div>
        ...
        <div class="mb-3">
            <label for="dcapi" class="form-label">Capital</label>
            <input type="text" required class="form-control" id="capi" name="capi"
                placeholder="capi name" value="{{ $pais->pais_capi }}">
            <div class="form-text">Capital.</div>
        </div>
